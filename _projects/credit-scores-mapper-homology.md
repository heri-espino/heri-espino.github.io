...
permalink: /academic-projects/credit-scores-mapper-homology.html
portfolio_type: project
importance: 8
portfolio_section: academic-projects
academic_project: true
card_kind: Course project
title: Credit Scores with Mapper and Homology
...
contributions:
  ...
  - Uses persistent-homology concepts to study structure in the classification problem.
  - Provides an executed notebook with the analysis and visual outputs.
---
